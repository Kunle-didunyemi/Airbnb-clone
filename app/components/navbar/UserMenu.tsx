  ...
  return (
    <div className=" relative">
      <div className=" flex flex-row items-center gap-3 ">
        <div
          onClick={onRent}
          className="hidden md:block text-sm font-semibold py-3 px-4 rounded-full hober:bg-neutral-100 transition cursor-pointer"
        >
          Airbnb your home
        </div>
        <div
          ...
          <div className=" flex flex-col cursor-pointer">
            {currentUser ? (
              <>
                ...
                <MenuItem onClick={rentModal.onOpen} label="Air bnb my home" />
                <hr />
